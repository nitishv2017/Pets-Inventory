...
public class EditorActivity extends AppCompatActivity {
    ...
    public String converteditText(Editable e)
    {
    ...
    private void insertPet() {
        ...
        String name=converteditText(mNameEditText.getText());
        String breed=converteditText(mBreedEditText.getText());
        int gender=mGender;
        String weight=converteditText(mWeightEditText.getText());
        Log.i(LOG_TAG, "insertPet: "+name.length());
